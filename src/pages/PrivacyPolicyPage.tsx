  ...
  return (
    <div className="min-h-screen pt-24 pb-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        >
          <h1 className="font-display text-4xl font-semibold text-neutral-900 mb-2">Privacy Policy</h1>
          ...
          <div className="prose-policy space-y-8 text-neutral-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">2. Information We Collect</h2>
              <p>We may collect the following types of information:</p>
              <ul className="list-disc pl-5 mt-3 space-y-2">
                <li><strong className="text-neutral-900">Personal Information:</strong> Full name, email address, phone number, delivery address, and payment details when you place an order.</li>
                <li><strong className="text-neutral-900">Account Information:</strong> Login credentials if you create an account with us.</li>
                <li><strong className="text-neutral-900">Transaction Information:</strong> Details about purchases, order history, payment method used (mobile money, card, or cash on delivery).</li>
                <li><strong className="text-neutral-900">Device & Usage Information:</strong> IP address, browser type, operating system, pages visited, time spent on site, and referring URLs collected automatically through cookies and similar technologies.</li>
                <li><strong className="text-neutral-900">Communication Data:</strong> Any messages or inquiries you send to us via email, WhatsApp, or social media.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">4. How We Share Your Information</h2>
              <p>We do not sell your personal information. We may share your data with:</p>
              <ul className="list-disc pl-5 mt-3 space-y-2">
                <li><strong className="text-neutral-900">Delivery Partners:</strong> To fulfil and ship your orders within Ghana and beyond.</li>
                <li><strong className="text-neutral-900">Payment Processors:</strong> Mobile money providers (MTN MoMo, Vodafone Cash, AirtelTigo Money) and card payment gateways to process transactions securely.</li>
                <li><strong className="text-neutral-900">Service Providers:</strong> Third-party services that help us operate our website (hosting, analytics, email services).</li>
                <li><strong className="text-neutral-900">Legal Requirements:</strong> When required by law, court order, or governmental authority in Ghana.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">5. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">6. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">7. Your Rights</h2>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">8. Third-Party Links</h2>
              <p>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">9. Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-neutral-900 text-lg font-semibold mb-3">10. Changes to This Policy</h2>
              <p>
