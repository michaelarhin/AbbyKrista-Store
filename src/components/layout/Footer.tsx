...
export default function Footer() {
  return (
    <footer className="relative mt-32 border-t border-cream-200 bg-cream-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-full border border-cream-300 flex items-center justify-center text-neutral-500 hover:text-primary-500 hover:border-primary-300 transition-all duration-200"
              >
                <Instagram size={15} />
              </a>
              <a
          ...
          <div>
            <h3 className="text-neutral-900 text-lg font-display font-semibold mb-2">Join the AB. family</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pb-16 border-b border-cream-200">
          <div>
            ...
            <ul className="space-y-3">
              {['Kitchen', 'Living Room', 'Bedroom', 'All Home Decor'].map(item => (
                <li key={item}>
                  <Link to="/products?category=abbyhaus" className="text-neutral-500 hover:text-primary-500 text-sm transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-neutral-900 text-sm font-semibold mb-4 tracking-wide">Company</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-neutral-900 text-sm font-semibold mb-4 tracking-wide">Legal</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/privacy-policy" className="text-neutral-500 hover:text-primary-500 text-sm transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-of-service" className="text-neutral-500 hover:text-primary-500 text-sm transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link to="/cookie-policy" className="text-neutral-500 hover:text-primary-500 text-sm transition-colors">
                  Cookie Policy
                </Link>
              </li>
              <li>
                <Link to="/refund-policy" className="text-neutral-500 hover:text-primary-500 text-sm transition-colors">
                  Refund Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 px-2 py-1 rounded bg-cream-100 border border-cream-200">
                ...
                <span className="text-neutral-600 text-xs font-semibold tracking-wide">Paystack</span>
              </div>
            </div>
          ...
          <div className="w-full border-t border-cream-200 pt-4 flex justify-center">
