  ...
  return (
    ...
    >
      <Link to={`/products/${product.slug}`} className="block">
        <div className="relative overflow-hidden rounded-2xl bg-white border border-neutral-100 hover:border-primary-200 shadow-sm hover:shadow-md transition-all duration-300">
          {/* Image */}
          ...
          <div className="p-4">
            {product.category && (
              <p className="text-primary-500 text-xs font-medium tracking-wide uppercase mb-1">
                {product.category.name}
              </p>
            )}
            <h3 className="text-neutral-800 text-sm font-medium leading-snug line-clamp-2 mb-2">
              {product.name}
            </h3>
